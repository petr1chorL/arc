...
```powershell
Get-Content .scratch\runtime\web.log -Tail 80
Get-Content .scratch\runtime\api.log -Tail 80
```
...
```powershell
Get-Content .scratch\runtime\execution-worker.log -Tail 80
